...
class NameDetector:
    ...
    def _regex_spans(self, text: str) -> List[DetectedSpan]:
        patterns: list[re.Pattern[str]] = [
            ...
            # г-н Иванов И.И.
            re.compile(r"\b(г-н|г-жа|гражданин|гражданка)\s+[А-ЯЁ][а-яё-]{2,}\s+[А-ЯЁ]\.\s*[А-ЯЁ]\.?\b", re.IGNORECASE),
            ...
            # директор Иванов И.И.
            re.compile(r"\b(директор|руководитель|подписант|представитель)\s+[А-ЯЁ][а-яё-]{2,}\s+[А-ЯЁ]\.\s*[А-ЯЁ]\.?\b", re.IGNORECASE),
            # в лице / действующий через
            re.compile(r"\b(в\s+лице|действующ(?:ий|ая)\s+через)\s+[А-ЯЁ][а-яё-]{2,}(?:\s+[А-ЯЁ][а-яё-]{2,}){0,2}\b", re.IGNORECASE),
            # в лице Иванов И.И.
            re.compile(r"\b(в\s+лице|действующ(?:ий|ая)\s+через)\s+[А-ЯЁ][а-яё-]{2,}\s+[А-ЯЁ]\.\s*[А-ЯЁ]\.?\b", re.IGNORECASE),
        ]
